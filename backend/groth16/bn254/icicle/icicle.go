...
func Prove(r1cs *cs.R1CS, pk *ProvingKey, fullWitness witness.Witness, deviceIndex int, opts ...backend.ProverOption) (*groth16_bn254.Proof, error) {
	if deviceIndex < 0 {
		deviceIndex = 0
	}
	...
	device := icicle_runtime.CreateDevice("CUDA", deviceIndex)
